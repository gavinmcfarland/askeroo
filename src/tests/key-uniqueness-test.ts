...
console.log(
	"Step 1: Creating complex tree with potential duplicate scenarios..."
);
...
function simulateKeyGeneration(
	node: any,
	depth = 0,
	parentId = "root",
	context = "test"
...
console.log(
	"  1. Keys include parent context to prevent cross-group collisions"
);
console.log("  2. Array index ensures siblings have unique keys");
console.log(
	"  3. Node depth and state prevent same node having duplicate keys"
);
